...
void ofApp::setup(){
	...
	consoleListener.setup(ofxConsoleListener::NOTIFY_KEY_MODE);
	ofAddListener(consoleListener.newKeyEvent, this, &ofApp::newKeyFromConsole);
...
void ofApp::newKeyFromConsole(int & key) {
	switch (key) {
